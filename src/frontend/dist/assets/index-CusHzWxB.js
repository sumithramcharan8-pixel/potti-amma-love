...
— With all my love`;
const LINE_KEYS = FULL_MESSAGE.split("\n").map((t, pos) => {
  if (t === "") return `blank-${pos}`;
  return t.slice(0, 28).replace(/\s+/g, "-").replace(/[^a-z0-9-]/gi, "").toLowerCase() || `line-${pos}`;
});
...
const PETALS = Array.from({ length: 18 }, (_, i) => {
  const r = (offset) => (i * 137 + offset * 31) % 97 / 97;
  return {
    id: `petal-${i}`,
    left: r(0) * 100,
    bottom: -(r(1) * 15 + 2),
...
const SPARKLES = Array.from({ length: 28 }, (_, i) => {
  const r = (offset) => (i * 97 + offset * 53) % 89 / 89;
  return {
    id: `sparkle-${i}`,
    left: r(0) * 98,
    top: r(1) * 95,
...
function MessageLine({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "span",
      {
        ...
        style: {
          ...
          lineHeight: 1.15,
          color: "#fde68a",
          textShadow: "0 0 20px rgba(253,230,138,0.7), 0 0 40px rgba(232,121,249,0.5), 0 2px 8px rgba(0,0,0,0.8)"
        },
        children: [
          text,
          showCursor && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "typewriter-cursor" })
        ]
      },
      lineKey
    );
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "span",
      {
        ...
        style: {
          ...
          color: "#f9a8d4",
          fontStyle: "italic",
          textShadow: "0 0 16px rgba(249,168,212,0.8), 0 2px 6px rgba(0,0,0,0.7)"
        },
        children: [
          text,
          showCursor && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "typewriter-cursor" })
  ...
  if (text === "") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block", style: { height: "1em" }, children: showCursor && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "typewriter-cursor" }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "span",
    {
...
function App() {
  ...
  const [bloom, setBloom] = reactExports.useState(false);
  const [pageVisible, setPageVisible] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    ...
    const t = setTimeout(() => setConfetti([]), 6e3);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `min-h-screen w-full relative overflow-hidden flex items-center justify-center py-12 px-4 transition-opacity duration-1000 bg-scene ${pageVisible ? "opacity-100" : "opacity-0"} ${done ? "orb-bloom" : ""}`,
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "orb orb-3", "aria-hidden": "true" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "orb orb-4", "aria-hidden": "true" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "orb orb-5", "aria-hidden": "true" }),
        ...
        bloom && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              ...
              height: "60vw",
              borderRadius: "50%",
              background: "radial-gradient(circle, rgba(232,121,249,0.75) 0%, rgba(124,58,237,0.55) 40%, transparent 70%)",
              zIndex: 10
            }
          }
        ),
        confetti.map((piece) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "confetti",
            style: {
              left: `${piece.x}%`,
              top: "-10px",
              width: piece.shape === "circle" ? `${piece.size}px` : `${piece.size * 0.7}px`,
              height: piece.shape === "circle" ? `${piece.size}px` : `${piece.size * 1.4}px`,
              backgroundColor: piece.color,
              borderRadius: piece.shape === "circle" ? "50%" : "2px",
              transform: piece.shape === "diamond" ? "rotate(45deg)" : void 0,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              boxShadow: "0 8px 64px rgba(148,0,211,0.3), 0 2px 24px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.08)",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    LINE_KEYS.slice(0, currentLines.length).map((lineKey, pos) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      MessageLine,
                      {
                        lineKey,
              ...
              done && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
          ...
          "div",
          {
            ...
            style: { zIndex: 5 },
            "aria-hidden": "true",
            children: EMOJI_FLOATS.map(({ id, symbol, left, bottom }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                style: {
                  position: "absolute",
